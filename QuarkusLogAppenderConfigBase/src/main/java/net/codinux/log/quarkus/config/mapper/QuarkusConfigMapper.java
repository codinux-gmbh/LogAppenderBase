...
public class QuarkusConfigMapper {
    ...
    public static LogAppenderConfig mapConfig(QuarkusLogAppenderConfigBase config) {
        LogAppenderConfig mappedConfig = new LogAppenderConfig();

        mapConfigTo(config, mappedConfig);
    ...
    public static LogAppenderFieldsConfig mapFields(QuarkusLogAppenderFieldsConfig fields) {
    ...
    public static KubernetesFieldsConfig mapKubernetesFields(QuarkusKubernetesFieldsConfig fields) {
    ...
    public static String mapNullableString(Optional<String> value) {
